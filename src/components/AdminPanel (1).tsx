  ...
  return (
    <div className="min-h-screen bg-[#F6F2E7] font-[Inter,system-ui,sans-serif] text-[#1A2E26] selection:bg-[#1A3D32] selection:text-white flex flex-col lg:flex-row relative">
      ...
      <button 
        ...
        className="lg:hidden fixed bottom-6 right-6 z-40 bg-[#0F2E26] text-white p-4 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all border-2 border-white/20"
      >
        <Terminal size={24} />
      </button>
      ...
      {showModuleOverlay && overlayTab && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="bg-[#F6F2E7] w-full max-w-5xl max-h-[90vh] rounded-3xl overflow-hidden shadow-2xl relative animate-in zoom-in-95 duration-200 flex flex-col">
            <div className="p-6 bg-[#0F2E26] text-white flex items-center justify-between shrink-0">
               <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold capitalize">{overlayTab.replace('_', ' ')}</h2>
                    <p className="text-xs text-white/60">Configuración y gestión del módulo</p>
                  </div>
               </div>
